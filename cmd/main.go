...
func main() {
	...
	services, err := app.NewServices(pool, cfg.GeminiAPIKey, cfg.AnthropicAPIKey, cfg.JWTSecret, cfg.DatabaseURL, cfg.QdrantURL, cfg.QdrantAPIKey, cfg.RedisURL, cfg.MinioEndpoint, cfg.MinioAccessKey, cfg.MinioSecretKey, cfg.MinioBucket, cfg.MinioUseSSL, cfg.MinioPublicURL, cfg.TelegramBotToken, cfg.TelegramHRBotToken)
	if err != nil {
